...
Idiomatic usage of `go/scanner` drawn from the package's own runnable examples. Keywords: go/scanner scanner usage example idiomatic how to use Scanner Scan.
