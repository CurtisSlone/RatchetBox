...
Idiomatic usage of `go/token` drawn from the package's own runnable examples. Keywords: go/token token usage example idiomatic how to use  retrieve Position Info.
