...
Generate an ECDSA key pair on the P-256 curve, sign a SHA-256 message hash with ASN.1/DER encoding, and verify the signature. Keywords: GenerateKey SignASN1 VerifyASN1 PublicKey elliptic.P256 sha256.Sum256 rand.Reader sign verify signature elliptic curve digital signature ECDSA private key public key ASN.1 DER.
