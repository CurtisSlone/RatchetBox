...
Idiomatic usage of `go/ast` drawn from the package's own runnable examples. Keywords: go/ast ast usage example idiomatic how to use Comment Map Inspect Preorder.
